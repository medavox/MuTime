 ...
 */
abstract class JavaSntpClient {
    private static final String TAG = JavaSntpClient.class.getSimpleName();
     ...
     */
    synchronized static TimeData requestTime(String ntpHost,
                                       float rootDelayMax,
        ...
        try {
            ...
            if (rootDelay > rootDelayMax) {
                throw new InvalidNtpResponseValueException(
     ...
     */
    /*should be private */ static long read(byte[] buffer, int offset) {
     ...
     */
    /*should be private */ static void writeTimeStamp(byte[] buffer, int offset, long time) {
     ...
     */
    /*should be private */ static long readTimeStamp(byte[] buffer, int offset) {
     ...
     */
    /*should be private */ static int ui(byte b) {
        return b & 0xFF;
    }
    ...
    /*should be private */ static double doubleMillis(long fix) {
        return fix / 65.536D;
    }
